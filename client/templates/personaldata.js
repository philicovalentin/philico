var checkPhoneIsWrong = function (phNum) {
    if (phNum.length!=9){
        return true;}
    else {return false};
...
Template.personaldata.events({
    ...
    "submit .new-profile": function (event) {
        ...
        if (checkDomicilePhone.length>0 && checkPhoneIsWrong(checkDomicilePhone)) {
            alert("Please enter your domicile phone number using the format 781234567 (without the 0 at the beginning)")}
        else if (checkMobilePhone.length>0 && checkPhoneIsWrong(checkMobilePhone)) {
            alert("Please enter your mobile phone number using the format 781234567 (without the 0 at the beginning)")}
        else {
    ...
    "submit .new_internal": function(event){
        ...
        if (checkEmergencyPhone1.length>0 && checkPhoneIsWrong(checkEmergencyPhone1)) {
            alert("Please enter your emergency phone number 1 using the format 781234567 (without the 0 at the beginning)")}
        else if (checkEmergencyPhone2.length>0 && checkPhoneIsWrong(checkEmergencyPhone2)) {
            ...
            if (!myDocument1.emergency1Phone || event.target.emergency1Phone.value!==myDocument1.emergency1Phone || (event.target.emergency1countryCode.value!==myDocument1.emergency1countryCode.substring(1) && event.target.emergency1Phone.value!==myDocument1.emergency1Phone)) {
            ...
            if (!myDocument1.emergency2Phone || event.target.emergency2Phone.value!==myDocument1.emergency2Phone || (event.target.emergency2countryCode.value!==myDocument1.emergency2countryCode.substring(1) && event.target.emergency2Phone.value!==myDocument1.emergency2Phone)) {
